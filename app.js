var CFG = {};
var isLoading = false;
var EMOJIS = ['\u{1F393}','\u{1F3C6}','\u{1F30D}','\u{1F4DA}','\u{1F389}','\u{1F525}','\u{1F4A1}','\u{1F3AF}','\u{1F31F}','\u{1F4AB}'];
...
async function realRefresh() {
  ...
  try {
    if (CFG.ig) {
      ...
      document.getElementById('ig-content').innerHTML = emptyState('Instagram \u0430\u043a\u043a\u0430\u0443\u043d\u0442 \u043d\u0435 \u0443\u043a\u0430\u0437\u0430\u043d', '\u{1F4F8}', '\u041e\u0442\u043a\u0440\u043e\u0439\u0442\u0435 \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438');
    }
    if (CFG.tt) {
      ...
      document.getElementById('tt-content').innerHTML = emptyState('TikTok \u0445\u044d\u0448\u0442\u0435\u0433 \u043d\u0435 \u0443\u043a\u0430\u0437\u0430\u043d', '\u{1F3B5}', '\u041e\u0442\u043a\u0440\u043e\u0439\u0442\u0435 \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438');
    }
...
function renderIG(posts, lv, ld) {
  ...
  if (!posts.length) h = emptyState('\u041d\u0435\u0442 \u043f\u043e\u0441\u0442\u043e\u0432', '\u{1F4F8}', '\u0414\u0430\u043d\u043d\u044b\u0435 \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043d\u044b');
...
function igCard(p, isN) {
  ...
  return '<div class="card' + (isN ? ' is-new' : '') + '">' +
    ...
    '<div class="badges">' + (isN ? '<span class="b b-new">\u{1F195} \u041d\u043e\u0432\u043e\u0435</span>' : '') + (vr ? '<span class="b b-viral">\u0432\u0438\u0440\u0443\u0441\u043d\u044b\u0439</span>' : '') +
    ...
    '<div class="card-foot"><div class="meta"><span class="likes">\u2764 ' + fmtNum(p.likesCount || p.likes) + '</span><span>\u{1F4AC} ' + fmtNum(p.commentsCount || p.comments) + '</span></div>' +
...
function renderTT(videos, lv, ld) {
  ...
  var h = '';
  if (nV.length) h += sepNew('\u{1F3B5} \u041d\u043e\u0432\u043e\u0435 \u0432 TikTok \u2014 \u0441 ' + ld) + '<div class="tiktok-grid">' + nV.map(function(v) { return ttCard(v, gTs, gP, gL, gC, gS, gD, true); }).join('') + '</div>';
  ...
  if (!videos.length) h = emptyState('\u041d\u0435\u0442 \u0432\u0438\u0434\u0435\u043e', '\u{1F3B5}', '\u0414\u0430\u043d\u043d\u044b\u0435 \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043d\u044b');
...
function ttCard(v, gTs, gP, gL, gC, gS, gD, isN) {
  ...
  return '<div class="tt-card' + (isN ? ' is-new' : '') + '">' +
    ...
    '<div class="tt-meta"><span>\u2764 ' + fmtNum(gL(v)) + '</span><span>\u{1F4AC} ' + fmtNum(gC(v)) + '</span><span>\u2197 ' + fmtNum(gS(v)) + '</span></div>' +
    '</div></div>';
}
function renderWeb(items, lv, ld) {
  ...
  document.getElementById('web-sync-badge').textContent = '\u{1F195} ' + nI.length + ' \u043d\u043e\u0432\u044b\u0445';
  ...
  var h = '';
  if (nI.length) h += sepNew('\u{1F310} \u0418\u043d\u0442\u0435\u0440\u043d\u0435\u0442 \u2014 \u043d\u043e\u0432\u043e\u0435 \u0441 ' + ld) + '<div class="web-grid">' + nI.map(function(i) { return webCard(i, true); }).join('') + '</div>';
  if (oI.length) h += sepOld('\u0420\u0430\u043d\u0435\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043d\u043e\u0435') + '<div class="web-grid">' + oI.map(function(i) { return webCard(i, false); }).join('') + '</div>';
  if (!f.length) h = emptyState('\u041d\u0435\u0442 \u0443\u043f\u043e\u043c\u0438\u043d\u0430\u043d\u0438\u0439', '\u{1F310}', '\u041f\u043e\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u043e\u0431\u043d\u043e\u0432\u0438\u0442\u044c \u043f\u043e\u0437\u0436\u0435');
...
function webCard(item, isN) {
  ...
  return '<div class="web-card' + (isN ? ' is-new' : '') + '">' +
    '<div class="wc-body"><div class="web-source-icon">\u{1F4F0}</div>' +
    '<div class="web-main"><div class="web-title">' + (item.title || '\u2014') + '</div>' +
    '<div class="web-tags">' + (isN ? '<span class="web-tag wt-new">\u{1F195} \u041d\u043e\u0432\u043e\u0435</span>' : '') +
    ...
    '<a class="source-pill" href="' + (item.url || '#') + '" target="_blank">\u{1F4F0} ' + host + '</a></div></div>';
}
function loadIGFromExcel(input) {
  ...
  reader.onload = function(e) {
    try {
      ...
      if (wb2) { wb2.textContent = '\u{1F4C2} \u0417\u0430\u0433\u0440\u0443\u0436\u0435\u043d\u043e: ' + posts.length + ' \u043f\u043e\u0441\u0442\u043e\u0432'; wb2.style.display = 'block'; setTimeout(function() { wb2.style.display = 'none'; }, 5000); }
